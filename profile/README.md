...
AAO Data Lab is entirely volunteer-run and welcomes contributors across every discipline. You do not need to be a developer to contribute meaningfully.

| Discipline | What You'll Build |
|---|---|
| **Software Developers** | Web apps, APIs, interactive maps, data pipelines |
| **Data Analysts / Engineers** | Reproducible analysis notebooks, cleaned public datasets, economic models |
| **UI/UX Designers** | Component specs, accessibility audits, the AAO design system |
| **Policy Analysts** | Legislative context, source review, framing guides |
| **Researchers** | Literature reviews, comparable state programs, citations |
| **Project Managers** | Issue scoping, milestone tracking, cross-discipline coordination |
...
Part of [All Aboard Ohio](https://allaboardohio.org) · [lab.allaboardohio.org](https://lab.allaboardohio.org) · Volunteer-contributed, open source
